...
public class TestLOCReader {
	...
	public void TestExtractZip() {
		...
		final String expectedPath2 = "TestCases/t2/";
		final String expectedPath3 = "TestCases/t3";
		final String expectedPath1 = "TestCases/t1Nested/t1";

		File expectedDir2 = new File(expectedPath2);
		File expectedDir3 = new File(expectedPath3);
		/**
		 * Boundary Value Analysis t1 - A zip with a nested zip containing 3
		 * nested folders with 4 java source files which will return false t2 -
		 * A zip with multiple folders containing java source files will return
		 * true t3 - A zip with a folder containing a java source file wiull
		 * return true
		 *
	 ...
	 * test2.zip - a zip file that contains .java files in root, contains .java
	 * files in folders A and B test3.zip - a zip file that contains .java files
	 * in root, contains .java files in folders A and B, contains .java files in
	 * nested folders A1 and B1
	 */
