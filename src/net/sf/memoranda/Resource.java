...
public class Resource {
	...
	private boolean _isProjectFile = false; // true if file is in project
											// directory
	 ...
	 * @param isInetShortcut,
	 *            if the resource is a internet shortcut.
	 * @param isProjectFile,
	 *            if file is copied to project directory.
	 */
