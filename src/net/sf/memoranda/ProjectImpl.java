...
public class ProjectImpl implements Project {
	...
	/*
	 * public int getProgress() { Vector v = getAllTasks(); if (v.size() == 0)
	 * return 0; int p = 0; for (Enumeration en = v.elements();
	 * en.hasMoreElements();) { Task t = (Task) en.nextElement(); p +=
	 * t.getProgress(); } return (p*100)/(v.size()*100); }
	 */
	 ...
	 */
	/*
	 * public TaskList getTaskList() { return
	 * CurrentStorage.get().openTaskList(this); }
	 */
	/**
	 * @see net.sf.memoranda.Project#getNoteList()
	 */
	/*
	 * public NoteList getNoteList() { return
	 * CurrentStorage.get().openNoteList(this); }
	 */
	/**
	 * @see net.sf.memoranda.Project#getResourcesList()
	 */
	/*
	 * public ResourcesList getResourcesList() { return
	 * CurrentStorage.get().openResourcesList(this); }
	 */
}
