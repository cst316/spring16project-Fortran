...
public class Local {
	...
	public static String getTimeString(Calendar cal) {
		/*
		 * String h = String.valueOf(cal.get(Calendar.HOUR_OF_DAY)); if
		 * (h.length() < 2) { h = "0" + h; } String m =
		 * String.valueOf(cal.get(Calendar.MINUTE)); if (m.length() < 2) { m =
		 * "0" + m; } return h + ":" + m;
		 */
	...
	public static String getTimeString(int hh, int mm) {
		/*
		 * String h = String.valueOf(hh); if (h.length() < 2) { h = "0" + h; }
		 * String m = String.valueOf(mm); if (m.length() < 2) { m = "0" + m; }
		 * return h + ":" + m;
		 */
		Calendar cal = Calendar.getInstance();
