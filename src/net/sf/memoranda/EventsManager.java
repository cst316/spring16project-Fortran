...
public class EventsManager {
	...
	static {
		...
		if (_doc == null) {
			 ...
			 * _root.appendChild( new Comment(
			 * "This is JNotes 2 data file. Do not modify."));
			 */
	...
	public static Event createRepeatableEvent(int type, CalendarDate startDate, CalendarDate endDate, int period,
	...
	public static Collection getRepeatableEventsForDate(CalendarDate date) {
		...
		for (int i = 0; i < reps.size(); i++) {
			...
			// --- ivanrise
			// ignore this event if it's a 'only working days' event and today
			// is weekend.
