...
public class TaskDialog extends JDialog {
	...
	JCheckBox stop_Watch = new JCheckBox();
	...
	void jbInit() throws Exception {
		...
		stop_Watch.setSelected(false);
		timer.setSelected(false);
		stop_Watch.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
		...
		stop_Watch.setBounds(100, 100, 15, 15);
		stop_Watch.setText(("timer"));
		...
		stop_Watch.setBounds(50, 100, 15, 15);
		stop_Watch.setText(Local.getString("Timer"));
		...
		stopWatch.setText(Local.getString("Timer"));
		stop_Watch.setBounds(50, 100, 15, 15);
		stop_Watch.setText(Local.getString("StopWatch"));/////
		endDate.setBorder(border8);
		endDate.setPreferredSize(new Dimension(80, 24));
