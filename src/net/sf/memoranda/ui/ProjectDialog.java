...
public class ProjectDialog extends JDialog {
	...
	void jbInit() throws Exception {
		...
		header.setIcon(
				new ImageIcon(net.sf.memoranda.ui.ProjectDialog.class.getResource("resources/icons/project48.png")));
		topPanel.add(header);
		...
		// ((JSpinner.DateEditor)
		// endDate.getEditor()).setLocale(Local.getCurrentLocale());
		gbc = new GridBagConstraints();
		gbc.gridx = 4;
		gbc.gridy = 2;
		gbc.insets = new Insets(5, 0, 10, 5);
	...
	void sdButton_actionPerformed(ActionEvent e) {
		...
		startCalFrame.setSize((this.getContentPane().getWidth() / 2), this.getContentPane().getHeight());
	...
	void edButton_actionPerformed(ActionEvent e) {
		...
		endCalFrame.setSize((this.getContentPane().getWidth() / 2), this.getContentPane().getHeight());
