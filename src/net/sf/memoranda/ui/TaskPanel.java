...
public class TaskPanel extends JPanel {
	...
	void jbInit() throws Exception {
		...
		// new
		// ImageIcon(net.sf.memoranda.ui.AppFrame.class.getResource("resources/icons/todo_remove.png")));
		// added by rawsushi
		...
		taskTable.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
			...
			public void valueChanged(ListSelectionEvent e) {
				...
				// over-written later depending on whether it has sub tasks
				ppCalcTask.setEnabled(enbl); // default value to be over-written
												// later depending on whether it
												// has sub tasks
