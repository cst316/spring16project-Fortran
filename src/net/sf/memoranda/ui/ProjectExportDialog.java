	...
	void jbInit() throws Exception {
		...
		okB.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (fileChooser.getUI() instanceof BasicFileChooserUI) // Added
																		// to
																		// fix
																		// problem
																		// with
				...
				{// Added to fix problem with export note jcscoobyrs 17-Nov-2003
					// at 08:36:14 AM
					BasicFileChooserUI ui = (BasicFileChooserUI) fileChooser.getUI();// Added
																						// to
																						// fix
																						// problem
																						// with
																						...
																						// note
					// jcscoobyrs 17-Nov-2003 at 08:36:14 AM
					ui.getApproveSelectionAction().actionPerformed(e);// Added
																		// to
																		// fix
																		// problem
																		// with
																		...
																		// note
					// jcscoobyrs 17-Nov-2003 at 08:36:14 AM
				} // Added to fix problem with export note jcscoobyrs
					// 17-Nov-2003 at 08:36:14 AM
			}
		});
