...
public class AddResourceDialog extends JDialog {
	...
	void jbInit() throws Exception {
		...
		header.setIcon(new ImageIcon(
				net.sf.memoranda.ui.AddResourceDialog.class.getResource("resources/icons/resource48.png")));
	...
	/**
	 * set CANCELLED variable to false so we can know the user pressed the ok
	 * buton and close this dialog.
	 */
	...
	/**
	 * enable inetShorcutRB fields. Request focus for the text field so the user
	 * can start typing and set the urlField text selected
	 */
