...
public class FontDialog extends JDialog {
	...
	void jbInit() throws Exception {
		...
		header.setIcon(new ImageIcon(
				net.sf.memoranda.ui.htmleditor.ImageDialog.class.getResource("resources/icons/fontbig.png")));
		...
		colorB.setIcon(new ImageIcon(
				net.sf.memoranda.ui.htmleditor.FontDialog.class.getResource("resources/icons/color.png")));
