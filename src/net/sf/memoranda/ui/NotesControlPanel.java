...
public class NotesControlPanel extends JPanel {
	...
	void jbInit() throws Exception {
		...
		ppOpenB.setIcon(new ImageIcon(net.sf.memoranda.ui.AppFrame.class.getResource("resources/icons/nopen.png")));
		...
		boolean descSort = (Configuration.get("NOTES_SORT_ORDER").equals("true"));
	...
	void ppOpenB_actionPerformed(ActionEvent e) {
		notesPPMenu.show(toolBar, (int) ppOpenB.getLocation().getX(), (int) ppOpenB.getLocation().getY() + 24);
	}
