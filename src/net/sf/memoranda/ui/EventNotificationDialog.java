...
public class EventNotificationDialog extends JFrame {
	...
	public EventNotificationDialog(String title, String time, String text) {
		...
		timeLabel.setIcon(
				new ImageIcon(net.sf.memoranda.ui.TaskDialog.class.getResource("resources/icons/event48.png")));
	...
	void jbInit() throws Exception {
		...
		this.setIconImage(
				new ImageIcon(EventNotificationDialog.class.getResource("resources/icons/jnotes16.png")).getImage());
